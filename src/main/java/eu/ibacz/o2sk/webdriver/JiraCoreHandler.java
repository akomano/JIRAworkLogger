 ...
 *
 */
public class JiraCoreHandler {
        
    WebDriver driver;
    SimpleDateFormat sdf = new SimpleDateFormat("yyyy.MM.dd hh:mm");
    PeriodFormatter periodFormatter;
    
    public JiraCoreHandler() throws IOException {        
    ...
    public void claimWorkLogOnCurrentTicket(WorkLogDTO effort, boolean commit) {
    	
    	// firstly, we have to open appropriate ticket, we want to claim to
        ...
        dateStarted.sendKeys(Keys.HOME,Keys.chord(Keys.SHIFT,Keys.END), sdf.format(effort.getDateStarted()));        
